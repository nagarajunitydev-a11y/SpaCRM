...
import { normalizePhoneDigits } from '../core/validate.js';
 ...
 * Stored values are reduced to their national digits for pre-filling.
 */
export function phoneInput(name, opts = {}) {
    const { required = true, className = '', autocomplete = 'tel-national', value = '' } = opts;
