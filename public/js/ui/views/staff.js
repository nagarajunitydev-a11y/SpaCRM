        ...
        <div class="space-y-4">
            ${sectionHeader(
                ...
                `<div class="flex items-center gap-2">
                    ${infoIcon('staff', 'About Staff')}
                    ${tab === 'roster' ? actionButton('Add Staff', { action: 'modal', data: { modal: 'staff', tutorial: 'staff-add-button' }, iconName: 'user-plus' }) : ''}
                </div>`,
            )}

            <div data-tutorial="staff-tabs" class="flex items-center gap-1.5 bg-slate-900 border border-slate-800 rounded-2xl p-1">
                ${TABS.map((t) => `
